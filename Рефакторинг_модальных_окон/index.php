   ...
   <div class="container">
    <div class="header-content">
      ...
      <!-- /.seporator -->
       ...
       data-target="#feedback-modal">Подробнее о компании</button>
     </div>
     <!-- /.header-content -->
  ...
  <div class="swiper features-slider">
    ...
    <div class="slider-buttons">
      ...
      <div class="slider-button-next">
        <svg class="button-next" width="36" height="24">
 ...
 <!-- /.section clients -->
  <section class="section-blog">
    <div class="container">
     ...
     <h2 class="blog-title">Блог экспертов в области производства</h2>
    <!-- Slider main container -->
